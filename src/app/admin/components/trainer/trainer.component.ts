...
export class TrainerComponent {
  ...
  ngOnInit(): void {
    ...
    this.customerService.getTrainers().subscribe(res => this.records=res)
...
onSubmit()
{
  if(this.form.valid)
  {
    ...
    if(password.includes(firstName) || password.includes(lastName))
      ...
      {
        this.customerService.addTrainer(this.form.value).subscribe(res=>{
          console.log("Trainer created");
          this.messageService.add({severity:'success', summary:'Trainer Created', detail:''});
...
update()
{
  if(this.form.valid)
  {
    this.customerService.updateUser(this.form.controls['id'].value,this.form.value).subscribe(res=>{
      ...
      this.messageService.add({severity:'success', summary:'Trainer Updated', detail:''});
