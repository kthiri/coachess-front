...
export class HomeComponent implements OnInit {
  ...
  public slides = [
    { title: 'The biggest sale', subtitle: 'Special for today', image: 'assets/images/examples/img3.png' },
    { title: 'Summer collection', subtitle: 'New Arrivals On Sale', image: 'assets/images/examples/img4.jpg' },
    { title: 'The biggest sale', subtitle: 'Special for today', image: 'assets/images/examples/img2.jpg' },
    { title: 'Summer collection', subtitle: 'New Arrivals On Sale', image: 'assets/images/examples/img3.png' },
    { title: 'The biggest sale', subtitle: 'Special for today', image: 'assets/images/examples/img4.jpg' }
  ];
