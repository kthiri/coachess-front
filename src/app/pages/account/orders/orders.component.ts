...
export class OrdersComponent implements OnInit {
  ...
  // ]
  constructor(private customerService:CustomerService,public appService:AppService) { }

  ngOnInit() {
   
    this.customerService.getOrders(this.appService.user.email).subscribe(res=>{
      this.orders=res;
    })
